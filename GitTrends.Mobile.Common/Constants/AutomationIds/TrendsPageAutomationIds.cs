...
{
	public static class TrendsPageAutomationIds
	{
		...
		public const string StarsEmptyDataView = nameof(TrendsPageAutomationIds) + nameof(StarsEmptyDataView);
		...
		public const string ClonesStatisticsLabel = nameof(TrendsPageAutomationIds) + nameof(ClonesStatisticsLabel);
		public const string StarsHeaderMessageLabel = nameof(TrendsPageAutomationIds) + nameof(StarsHeaderMessageLabel);
		public const string ViewsClonesEmptyDataView = nameof(TrendsPageAutomationIds) + nameof(ViewsClonesEmptyDataView);
