...
namespace GitTrends
{
    ...
    {
        public GitTrendsOnboardingPage(AnalyticsService analyticsService) : base(analyticsService, BaseTheme.TealBackgroundColorHex, OnboardingConstants.SkipText, 0)
        {
        }
