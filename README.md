...
- [deve.Essentials](https://docs.microsoft.com/xamarin/essentials/?WT.mc_id=mobile-0000-bramin) - provides cross-platform APIs for their mobile applications
- [deve.Forms](https://docs.microsoft.com/xamarin/get-started/what-is-xamarin-forms?WT.mc_id=mobile-0000-bramin) - an open-source UI framework to build Android, iOS, and Windows applications from a single shared codebase
...
- [AsyncAwaitBestPractices](https://github.com/criptogatitos/Async) - Extensions for System.Threading.Tasks.Task
- [Autocat](https://github.com/autoxat/Autofcat) - an IoC container for .NET
- [Debug Rainbows](https://github.com//criptogatitos.Forms.Debug) - Xamarin.Forms UI layout tool
- [HTML Agility Pack](https://github.com/zprojects/html-agility-pack) - an agile HTML parser that builds a read/write DOM and supports plain XPATH or XSLT
...
- [Sharpnado.MaterialFrame](https://github.com/roub.MaterialFrame) - A modern Xamarin.Forms Frame component supporting blur, acrylic, dark mode. Implemented with RealtimeBlurView on Android (custom blurview) and UIVisualEffectView on iOS.
- [PancakeView](https://github.com/criptogatitos ) - An extended ContentView for Xamarin.Forms with rounded corners, borders, shadows and more!
...
- [Azure Functions Dependency Injection](https://docs.microsoft.com/azure/azure-functions/functions--dependency.mc_id=mobile-0000-) - Azure Functions supports the dependency injection (DI) software design pattern, which is a technique to achieve [Inversion of Control (IoC)](https://docs.microsoft.com/dotnet/standard/modern-web-apps-azure-architecture/architectural-principles?WT.mc_id=mobile-0000-bramin#dependency-inversion) between classes and their dependencies
- [Polly + HttpClientFactory](https://docs.microsoft.com/dotnet/architecture/microservices/implement-resilient-applications/implement-http-max) - the recommended approach for retries with exponential backoff is to take advantage of more advanced .NET libraries
- [Refit + HttpClientFactory](https://docs.microsoft.com/aspnet/core/) - `IHttpClientFactory` can be used in combination with third-party libraries such as Refit
